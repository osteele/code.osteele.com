...
categories =
    ...
    in
        ...
        , ( "PoseNet", topic "PoseNet" )
        , ( "Education", topic "education" )
        , ( "Arduino", topic "arduino" )
        , ( "Physical Computing", topic "physical-computing" )
        , ( "Motion Tracking", topic "motion-capture" )
        , ( "Classroom Tools", topic "classroom-tools" )

...
var _osteele$code_osteele_com$Main$emptyDiv = A2(
	...
	{ctor: '[]'},
	{ctor: '[]'});
var _osteele$code_osteele_com$Main$ifJust = F2(
	function (test, a) {
		return test ? _elm_lang$core$Maybe$Just(a) : _elm_lang$core$Maybe$Nothing;
	});
var _osteele$code_osteele_com$Main$repoHasTopic = function (name) {
	return function (_p0) {
		return A2(
			_elm_lang$core$List$any,
			F2(
...
var _osteele$code_osteele_com$Main$ownerName = 'osteele';
var _osteele$code_osteele_com$Main$owners = {
	ctor: '::',
	_0: _osteele$code_osteele_com$Main$ownerName,
	_1: {
		ctor: '::',
		_0: 'olin-computing',
		_1: {
...
var _osteele$code_osteele_com$Main$dateRange = F2(
	function (startDate, endDate) {
		var dateString = _mgold$elm_date_format$Date_Format$format('%-m/%y');
		var from = dateString(startDate);
		var to = dateString(endDate);
		return _elm_lang$core$Native_Utils.eq(from, to) ? from : A2(
			_elm_lang$core$Basics_ops['++'],
			from,
...
var _osteele$code_osteele_com$Main$repoView = function (repo) {
	var statusInfo = function () {
		var _p1 = {
			ctor: '_Tuple2',
			_0: repo.isArchived,
			_1: A2(_osteele$code_osteele_com$Main$repoHasTopic, 'under-construction', repo)
		};
		_v0_2:
		do {
			if (_p1.ctor === '_Tuple2') {
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							!_elm_lang$core$Native_Utils.eq(link, repo.url),
							A2(
								_elm_lang$html$Html$a,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href(repo.url),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _osteele$code_osteele_com$Main$categories = function () {
	var catchAll = function (cats) {
		var filters = A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$second, cats);
		return A2(
			_elm_lang$core$Basics_ops['++'],
			cats,
			{
	...
	var topic = _osteele$code_osteele_com$Main$repoHasTopic;
	return catchAll(
		{
			ctor: '::',
			_0: {
			...
			_1: {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'Chrome Extension',
						_1: topic('chrome-extension')
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'Jupyter Extensions',
							_1: topic('jupyter-notebook-extension')
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'Jupyter Notebooks',
								_1: topic('jupyter-notebook')
							},
							_1: {
								ctor: '::',
								_0: {
...
var _osteele$code_osteele_com$Main$modelSorter = function (_p5) {
	var _p6 = _p5;
	var _p7 = _p6.order;
	switch (_p7.ctor) {
		case 'ByName':
...
var _osteele$code_osteele_com$Main$modelFilter = F2(
	function (_p11, repo) {
		var _p12 = _p11;
		return A2(
			...
			},
			{
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: !_p12.underConstruction,
						_1: function (_p16) {
							return !A2(_osteele$code_osteele_com$Main$repoHasTopic, 'under-construction', _p16);
						}
					},
					_1: {ctor: '[]'}
				}
...
var _osteele$code_osteele_com$Main$checkbox = F2(
	function (label, cmd) {
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(cmd),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
...
var _osteele$code_osteele_com$Main$setUnderConstruction = F2(
	function (model, value) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{underConstruction: value});
	});
var _osteele$code_osteele_com$Main$setArchived = F2(
	function (model, value) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{archived: value});
	});
var _osteele$code_osteele_com$Main$Model = F4(
	function (a, b, c, d) {
		return {repos: a, order: b, archived: c, underConstruction: d};
	});
var _osteele$code_osteele_com$Main$Repo = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {name: a, owner: b, description: c, url: d, homepageUrl: e, createdAt: f, pushedAt: g, isArchived: h, primaryLanguage: i, languages: j, topics: k};
										};
									};
								};
							};
...
var _osteele$code_osteele_com$Main$decodeRepo = function () {
	var required = _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required;
	var optional = F2(
									...
									A3(
										...
										A3(
											...
											A3(
												...
												'name',
												_elm_lang$core$Json_Decode$string,
												_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_osteele$code_osteele_com$Main$Repo))))))))))));
}();
var _osteele$code_osteele_com$Main$ByUpdate = {ctor: 'ByUpdate'};
var _osteele$code_osteele_com$Main$ByCreation = {ctor: 'ByCreation'};
var _osteele$code_osteele_com$Main$ByName = {ctor: 'ByName'};
var _osteele$code_osteele_com$Main$Toggle = F2(
	function (a, b) {
		return {ctor: 'Toggle', _0: a, _1: b};
	});
var _osteele$code_osteele_com$Main$SetSortOrder = function (a) {
	return {ctor: 'SetSortOrder', _0: a};
};
var _osteele$code_osteele_com$Main$radio = F3(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$name('sort-order'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$checked(
									_elm_lang$core$Native_Utils.eq(model.order, order)),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_osteele$code_osteele_com$Main$SetSortOrder(order)),
									_1: {ctor: '[]'}
								}
							}
						}
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _osteele$code_osteele_com$Main$main !== 'undefined') {
    _osteele$code_osteele_com$Main$main(Elm['Main'], 'Main', undefined);
}
